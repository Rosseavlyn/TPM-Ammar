...
var tourismPlaceList = [
  TourismPlace(
    ...
    isFavorite: false,
    wikiUrl: "https://su.wikipedia.org/wiki/Farm_House_L%C3%A9mbang",
  ),
  TourismPlace(
    ...
    isFavorite: false,
    wikiUrl: "https://id.wikipedia.org/wiki/Observatorium_Bosscha",
  ),
  TourismPlace(
    ...
    isFavorite: false,
    wikiUrl: "https://id.wikipedia.org/wiki/Jalan_Asia_Afrika_(Jakarta)",
  ),
  TourismPlace(
    name: 'Stone Garden',
    location: 'Padalarang',
    ...
    isFavorite: false,
    wikiUrl:
        "https://id.wikipedia.org/wiki/Berkas:Stone_Garden,_Citatah,_Padalarang,_25022017.jpg",
  ),
  TourismPlace(
    ...
    isFavorite: false,
    wikiUrl:
        "https://id.wikipedia.org/wiki/Taman_Film#:~:text=Taman%20Film%20adalah%20salah%20satu,pada%20tanggal%2014%20September%202014.",
  ),
  TourismPlace(
    name: 'Museum Geologi',
    location: 'Kota Bandung',
    ...
    isFavorite: false,
    wikiUrl: "https://id.wikipedia.org/wiki/Museum_Geologi_Bandung",
  ),
  TourismPlace(
    ...
    isFavorite: false,
    wikiUrl: "https://id.wikipedia.org/wiki/Pasar_terapung",
  ),
  TourismPlace(
    name: 'Kawah Putih',
    location: 'Ciwidey',
    ...
    isFavorite: false,
    wikiUrl:
        "https://id.wikipedia.org/wiki/Kawah_Putih#:~:text=Kawah%20Putih%20adalah%20sebuah%20tempat,terbentuk%20dari%20letusan%20Gunung%20Patuha.",
  ),
  TourismPlace(
    name: 'Ranca Upas',
    location: 'Ciwidey',
    ...
    isFavorite: false,
    wikiUrl: "https://id.wikipedia.org/wiki/Ranca_Upas",
  ),
];
